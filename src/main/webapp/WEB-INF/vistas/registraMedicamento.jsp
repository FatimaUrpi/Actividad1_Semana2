		...
		<form id="id_form">
				...
				<div class="form-group col-sm-6">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" id="id_nombre"
							name="nombre" placeholder="Ingrese el nombre del medicamento"
							maxlength="40">
					</div>
				</div>
				<div class="form-group  col-sm-6">
					...
					<div class="col-sm-6">
						<input class="form-control" type="text" id="id_precio"
							name="precio" placeholder="Ingrese el precio" maxlength="6">
					</div>
				</div>
			</div>
			<div class="row" style="margin-top: 0%">
				<div class="form-group col-sm-6">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" id="id_stock" name="stock"
							placeholder="Ingrese el stock" maxlength="150">
					</div>
				</div>
				<div class="form-group col-sm-6">
					<div class="col-sm-4">
					...
					<div class="col-sm-8">
						<input class="form-control" type="text" id="id_laboratorio"
							name="laboratorio"
							placeholder="Ingrese el nombre del Laboratorio" maxlength="40">
					</div>
				</div>
			</div>
            ...
            stock: {
                ...
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 150,
                        message: 'El stock es de 2 a 150 dígitos'
                    }
                }
            },
            laboratorio: {
